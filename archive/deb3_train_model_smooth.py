...
file_path = select_raw_landmark_files("raw_worldlandmarks_smooth")[0]
...
base_dir = os.getcwd()
landmarks_rel_path = os.path.relpath(file_path, os.path.join(base_dir, "raw_worldlandmarks_smooth"))
